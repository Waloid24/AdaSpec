    ...
    def forward(
        ...
        if self.use_flashinfer:
            ...
            if target_token_ids is not None:
                ...
                # Greedy decoding for speculative decoding.
                target_tokens_without_bonus = target_token_ids[:, :-1]
                accepted = (draft_token_ids == target_tokens_without_bonus)
                return self._create_output(
                    accepted,
                    target_tokens_without_bonus,
                    draft_token_ids,
                    bonus_token_ids,
                )
