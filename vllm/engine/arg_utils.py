...
class EngineArgs:
    ...
    rsd: Optional[bool] = None
    specinfer: Optional[bool] = None
    dynamic_spec : Optional[bool] = None
    assistant_confidence_threshold: float = 0.6
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument('--dynamic-spec', action='store_true')
        parser.add_argument("--assistant-confidence-threshold", type=float, default=0.6)
        parser.add_argument(
